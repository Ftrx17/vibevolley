...
<head>
    ...
    <style>
        ...
        h1 { color: #667eea; font-size: 2em; margin-bottom: 20px; font-weight: 800; text-align: center; }
...
<body>
    <div class="form-container">
        <h1>Edit Product</h1>
        <form method="post" action="/admin/editProduct/<?= esc($product['id']) ?>">
            ...
            <input type="number" name="price" id="price" step="0.01" value="<?= esc($product['price']) ?>" required>
            <label for="stock">Stock</label>
            <input type="number" name="stock" id="stock" value="<?= esc($product['stock']) ?>" required>
